...
namespace ams::ssl::sf {
    ...
    enum class CaCertificateId : u32 {
        ...
        DigiCertGlobalRootG3 = 1042,
        DigiCertTrustedRootG4 = 1043,
        EntrustRootCertificationAuthorityEC1 = 1044,
        EntrustRootCertificationAuthorityG4 = 1045,
        GlobalSignECCRootCAR4 = 1046,
        GlobalSignECCRootCAR5 = 1047,
        GlobalSignECCRootCAR6 = 1048,
        GTSRootR1 = 1049,
        GTSRootR2 = 1050,
        GTSRootR3 = 1051,
        GTSRootR4 = 1052,
        SecurityCommunicationRootCA = 1053,
        DigiCertTLSECCP384RootG5 = 1054,
        DigiCertTLSRSA4096RootG5 = 1055,
        NintendoTempRootCAG4 = 65536,
        All = 4294967295,
    };
